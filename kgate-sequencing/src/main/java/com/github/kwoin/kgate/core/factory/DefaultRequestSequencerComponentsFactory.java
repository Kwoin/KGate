 ...
 * @author P. WILLEMET
 */
public class DefaultRequestSequencerComponentsFactory extends AbstractDefaultSequencerComponentsFactory {


    public DefaultRequestSequencerComponentsFactory(Class<? extends ISequencer> sequencerClass) {
    ...
    public IChain onNewMessage(IContext context) {
        ...
        return new DefaultChain(new SimpleLoggerCommand("New Request!"), new SimpleRelayerCommand());
